...
public class MainGame {
    ...
    private void endGame() {
        ...
        if (onGameEndedListener != null) {
            onGameEndedListener.onGameEnded();
        }
    }
    ...
    public MainView.OnGameEndedListener getOnGameEndedListener() {
        return onGameEndedListener;
    }

    public void setOnGameEndedListener(MainView.OnGameEndedListener onGameEndedListener) {
