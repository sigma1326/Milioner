...
//        drawInstructions(canvas);
    ...
    private void getLayout(int width, int height) {
        ...
        startingX = (int) (screenMiddleX - (cellSize + gridWidth) * halfNumSquaresX - gridWidth / 2f);
        endingX = (int) (screenMiddleX + (cellSize + gridWidth) * halfNumSquaresX + gridWidth / 2f);
...
//        headerTextSize = textSize * 2;
    ...
    public void setOnGameEndedListener(OnGameEndedListener onGameEndedListener) {
        ...
        game.setOnGameEndedListener(onGameEndedListener);
    }
